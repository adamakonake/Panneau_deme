...
class EquipementPage extends StatefulWidget {
  const EquipementPage({super.key});
...
class _EquipementPageState extends State<EquipementPage> {
        ...
        child: Stack(
          children: [
                                              ...
                                              GestureDetector(
                                                onTap: (){
                                                  if(_formKey.currentState!.validate()){
                                                    Provider.of<EquipementService>(context,listen: false).applySearch(_searchInputController.text);
            ...
            Container(
              ...
              child: Consumer<EquipementService>(
                builder: (context, equipementService, child) {
                  return FutureBuilder(
                    future: equipementService.getEquipements(),
                      ...
                      return RefreshIndicator(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return CardEquipement(equipement: snapshot.data![index],index: index);
                          },
                        ),
                      );
                    },
  ...
  _buildTrieButton(){
    return PopupMenuButton(
      onSelected: (value) {
        setState(() {
          Provider.of<EquipementService>(context,listen: false).applyTrie(value);
        });
      },
      ...
      child: const Icon(Icons.unfold_more_outlined ,color: Colors.white,size: 35)
    );
  }
